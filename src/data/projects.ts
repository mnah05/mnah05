...
export const PROJECTS: Project[] = [
  {
    ...
    name: "Envitoo",
    tagline:
      "Event management with ticketing, QR check-in, and volunteer coordination.",
    short:
      "An event platform for tickets, guest check-in, and volunteer coordination.",
    summary: [
  ...
  },
  {
    ...
    name: "go-analytics",
    tagline:
      "A fast URL shortener with click tracking that runs in the background.",
  ...
  },
  {
    ...
    name: "tripnest",
    tagline:
      "A backend for planning trips, building itineraries, and managing travel details.",
  ...
  },
  {
    ...
    name: "nexus",
    tagline:
      "A data store that keeps information synchronized across several servers.",
